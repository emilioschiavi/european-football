...
import nf.co.emilianku.europeanfootbal.gui.leaguetable.LeagueTablePresenter;

/**
 * Created by emilio on 23.04.17.
 */

@Module(library = false, injects = {CompetitionsPresenter.class, CompetitionPresenter.class, LeagueTablePresenter.class}, complete = true)
